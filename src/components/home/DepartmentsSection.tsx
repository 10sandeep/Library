...
export default function DepartmentsSection() {
  return (
    <section style={{ background: "#ededed", paddingTop: 64, paddingBottom: 64 }} aria-labelledby="dept-heading">
      <LayoutContainer>
          ...
          {DEPARTMENTS.map((dept) => {
            ...
            return (
              <Link
                ...
                className="bg-[#f5f5f5] border border-[#d6d6d6] flex flex-col items-center text-center hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)] hover:-translate-y-0.5 transition-all duration-200 group"
                style={{ borderTop: `8px solid ${dept.color}`, padding: 16, gap: 12 }}
